...
# ==========================================
# VWAP Indicator made 271% Profit! (Full Tutorial)
# https://youtu.be/Bx2NTG4pylw
# ==========================================
...
freqtrade hyperopt \
    --strategy VWAP_ADX \
    --config user_data/binance_futures_VWAP_ADX.json \
    --timeframe 1h \
...
freqtrade backtesting \
    ...
    --breakdown month \
    -c user_data/binance_futures_VWAP_ADX.json \
    --max-open-trades 1 \
    --cache none \
    --timeframe-detail 5m \
    -p NEAR/USDT:USDT
